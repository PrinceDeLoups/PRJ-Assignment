                    ...
                    <tbody>
                        ...
                        <td valign="top">
                            <c:forEach items="${requestScope.courses}" var="c" varStatus="loop">                           
                                <strong><a style="margin-bottom: 5px" href="group?course=${c.id}" name="course">${c.name} </a></strong><strong>(${c.code})</strong>
                                        <br/>
                                    </c:forEach>
                                    </td>
                                    <td valign="top">
                                        <c:forEach items="${requestScope.groups}" var="g" varStatus="loop">
                                            <strong><a href="group?class=${g.id}" name="class" >${g.name}</input></a></strong>
                                            <br/>
                                        </c:forEach>
                                                ...
                                                <tbody>
                                                    <c:forEach items="${requestScope.students}" var="s" varStatus="loop">
                                                        <tr>
                                                            ...
                                                            <td><strong><fmt:formatDate type = "date" value = "${s.dob}"/></strong></td>
